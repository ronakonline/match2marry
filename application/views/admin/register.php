                        ...
                        <div class="card-body">
                            <div class="px-3">
                                ...
                                <div class="text-center auth-logo-text">
                                    <h4 class="mt-0 mb-3 mt-5">Free Register for Match2Marry</h4>
                                    <p class="text-muted mb-0">Get your free Match2Marry account now.</p>  
                            ...
                            <div class="m-3 text-center text-muted">
                                <p class="">Already have an account ? <a href="login.php" class="text-primary ml-2">Log in</a></p>
                            </div>
                        </div><!--end card-body-->
                    </div><!--end card-->
                </div><!--end auth-card-->
