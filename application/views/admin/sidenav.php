...
<div class="left-sidenav">
    ...
    <div class="main-menu-inner">
        <div class="menu-body slimscroll">
            <div id="MetricaAnalytic" class="main-icon-menu-pane active">
                <div class="title-box">
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item"><a class="nav-link unactive" href="\light/analytics/analytics-customers.php"><i class="dripicons-user-group"></i>Customers</a></li>
