    ...
    <div class="atbd_content_module atbd_listing_details">
        <div class="atbd_content_module__tittle_area">
            <div class="atbd_area_title">
                <h4><span class="la la-file-text-o"></span>About KADEEJA</h4>
            </div>
        </div>
        ...
        <div class="atbdb_content_module_contents">
            <ul class="atbd_custom_fields features-table">
                ...
                <li>
                    ...
                    <div class="atbd_custom_field_content">
                        <p>English,Urdu,Hindi,Bengali</p>
                    </div>
                </li>
            </ul>
        </div>
						...
						<article class="atbd_single_listing_wrapper">
							<figure class="atbd_listing_thumbnail_area">
								<div class="atbd_listing_image" >
									<a href="#">
										<img src="<?php echo base_url();?>assets/images/girl3.jpg" alt="listing image" height="310" width="220" >
									</a>
								...
								<div class="atbd_content_upper">
									...
									<div class="atbd_listing_data_list">
										<ul>
											...
											<li>
												<p><span class="la la-user"></span>31 Years - 5.05 Ft </p>
											</li>
											<li>
												<p><span class="la la-book"></span>Muslim-Sunni</p>
											</li>
											<li>
												<p><span class="la la-briefcase"></span>Doctor</p>
											</li>
											<li>
            ...
            <ul>
				<li class="atbd_open">
					...
					<div class="atbd_open_close_time">
						<span class="time">Single</span>
					</div>
				</li>
                <li class="atbd_open">
                    <span class="day">Phsique</span>
                    <div class="atbd_open_close_time">
                        <span class="time">Slight Over Weight</span>
                    </div>
                </li>
                <li class="atbd_open ">
                    <span class="day">Health</span>
                    <div class="atbd_open_close_time">
                        <span class="time">Healthy</span>
                    </div>
                </li>
                <li class="atbd_open">
                    <span class="day">Way of Living</span>
                    <div class="atbd_open_close_time">
                        <span class="time">Simple</span>
                    </div>
                </li>
                <li class="atbd_open">
                    <span class="day">Family/Tribe</span>
                    <div class="atbd_open_close_time">
                        <span class="time">Khan</span>
                    </div>
                </li>
                <li class="atbd_open">
                    <span class="day">Religious Practice</span>
                    <div class="atbd_open_close_time">
                        <span class="time">Zakat</span>
                    </div>
                </li>
                <li class="atbd_open">
