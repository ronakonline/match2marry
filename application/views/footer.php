			...
			<div class="row">
				<div class="col-lg-2 col-sm-6">
					...
					<div class="widget widget_pages">
						...
						<ul class="list-unstyled">
							...
							<li class="page-item"><a href="<?php echo base_url();?>/contactus">Contact Us</a></li>
				...
				<div class="col-lg-3 d-flex justify-content-lg-center  col-sm-6">
					...
					<div class="widget widget_pages">
						...
						<ul class="list-unstyled">
							...
							<li class="page-item"><a href="#">Join Match 2 Marry</a></li>
							...
							<li class="page-item"><a href="#">App</a></li>
				...
				<div class="col-lg-4 col-sm-6">
					...
					<div class="widget widget_text">
						<h2 class="widget-title">Match 2 Marry on Mobile</h2>
						<div class="textwidget">
							<p>Download the Match 2 Marry app today so you can find your events anytime, anywhere.</p>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="footer-bottom--content">
						<a href="#" class="footer-logo m-right-10"><img src="<?php echo base_url();?>assets/images/Final.png" alt="" height="100px" width="350px"></a>
						<p class="m-0 copy-text">©2019 All Rights Reserved by Nex Solutions </p>
